...
VALUES 
(15, 'Apple Pie', 'Medium', 5, 'unit', CURRENT_TIMESTAMP);
...
/* There are some NULL values that we can update to 0 */
/* I know I should've got Null values in the first query but I handled them here. */
